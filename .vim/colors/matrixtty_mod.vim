...
"
" matrixtty_mod.vim - MATRIX like colorscheme, for tty
"
" Maintainer: psimpalton@gmail.com
" Last Modified: 2012, April 26

" Based on matrix.vim by MURAOKA Taro <koron@tka.att.ne.jp>
...
hi CursorColumn ctermfg=2 ctermbg=7 cterm=none
hi CursorLine ctermfg=2 ctermbg=7 cterm=none

highlight Function cterm=none ctermfg=4
"highlight cFunction cterm=none ctermfg=4
"highlight Identifier cterm=bold ctermfg=2
